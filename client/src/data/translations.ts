...
export const translations: Record<string, Translation> = {
  en: {
    ...
    resumeDesc: 'Professional CV and Portfolio Summary',
    ...
    helpCommand: 'Available commands: whoami, dir, about, skills, contact, clear, exit',
    whoamiResponse: 'SWAGY - Creative Developer & Designer',
    dirResponse: 'Directory listing:\n  projects/\n  skills/\n  contact.txt\n  readme.md',
    aboutResponse: 'Passionate full-stack developer with 5+ years experience.\nSpecializing in modern web technologies and user experience.',
    skillsResponse: 'JavaScript, React, Node.js, Python, UI/UX Design, Creative Coding',
    contactResponse: 'Email: swagy@example.com\nTwitter: @swagy_dev\nLinkedIn: /in/swagy',
  ...
  ar: {
    ...
    resumeDesc: 'السيرة الذاتية المهنية وملخص الأعمال',
    ...
    terminalWelcome: 'Microsoft(R) MS-DOS(R) Version 6.22',
    terminalCopyright: '(C)Copyright Microsoft Corp 1981-1994.',
    helpCommand: 'الأوامر المتاحة: whoami, dir, about, skills, contact, clear, exit',
    whoamiResponse: 'SWAGY - مطور ومصمم إبداعي',
    dirResponse: 'قائمة المجلدات:\n  projects/\n  skills/\n  contact.txt\n  readme.md',
    aboutResponse: 'مطور شامل شغوف مع خبرة أكثر من 5 سنوات.\nمتخصص في تقنيات الويب الحديثة وتجربة المستخدم.',
    skillsResponse: 'JavaScript, React, Node.js, Python, تصميم واجهة المستخدم, البرمجة الإبداعية',
    contactResponse: 'البريد الإلكتروني: swagy@example.com\nتويتر: @swagy_dev\nلينكد إن: /in/swagy',
